...
where use *`A`* - slowly varying complex amplitude of laser field, `r` ew Use `gs` and `git status` to list all new or modified files that haven't yet been committed.
