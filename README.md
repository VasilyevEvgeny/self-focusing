...
<p align="center">
 <img src="https://latex.codecogs.com/gif.latex?2&space;i&space;k_0\frac{\partial&space;A(\mathbf{r},z)}{\partial&space;z}=\Delta_\perp&space;A(\mathbf{r},z)&plus;\frac{2k_0^2}{n_0}n_2&space;I(\mathbf{r})A(\mathbf{r},z)">
</p>
