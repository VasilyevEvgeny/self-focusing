...
class Medium:
    ...
    def __initialize_parameters(self, lambda_1, lambda_2, lambda_3, C_1, C_2, C_3):
    ...
    def __initialize_SiO2(self):
        ...
        self.__initialize_parameters(lambda_1, lambda_2, lambda_3, C_1, C_2, C_3)

    def __initialize_CaF2(self):
        C_1 = 0.5675888000
        C_2 = 0.4710914000
        C_3 = 3.8484723000
